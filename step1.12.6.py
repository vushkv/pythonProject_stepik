...
"""
x = input()
lstSym = int(x[len(x) - 1]) # последний символ
lstSecSym = int(x[len(x) - 2]) # предпоследний символ
if(lstSym == 1 and (lstSecSym != 1 or len(x) == 1)):
    print(x, "программист")
elif((lstSym == 2 or lstSym == 3 or lstSym == 4) and lstSecSym != 1):
